...
explicitly. `purpose_subtype_codeplan_sentinels`, `leisure_unspecified_subtype` and
`secondary_mid_weekday_legs_only` need no such rejection — the trip build reads none of
