...
| `diary_match_fine_child_age_bands` | Bands 6-13-year-olds finely (6-9 / 10-13) for the diary plan match's `age_band` key, so a primary-school child cannot inherit a 13-year-old's school day; the weekend plan match keeps the coarse bands, and crossings are counted and logged in both arms |
