...
#
# Left in this module (rather than moved to economic_status.py with the other
# economic-status names) because its only consumer, _sample_cars_income_aware,
# still lives here; it will move together with that function in a later split.
