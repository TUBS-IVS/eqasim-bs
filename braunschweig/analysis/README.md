...
python scripts/run_synpp.py configs/fixtures/config_local_braunschweig_10pct.yml

# 2. Generate / refresh the 25 % synthesis
python scripts/run_synpp.py configs/fixtures/config_local_braunschweig_25pct.yml
