...
# (eqasim-data/data/braunschweig/srv/srv2023_raw/SrV2023_Personen.csv and
# SrV2023_Wege.csv).
#
...
def compute_participation(persons: pd.DataFrame, wege: pd.DataFrame) -> pd.DataFrame:
    ...
    persons : pd.DataFrame
        Persons table with columns: HHNR, PNR, ST_CODE, GEWICHT_P_ZENSUS.
    wege : pd.DataFrame
    ...
    persons["ars5"] = persons["ST_CODE"].astype(str).str.zfill(5)
