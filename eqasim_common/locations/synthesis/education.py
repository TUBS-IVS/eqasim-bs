"""Per-person education-location sampler.

Origin: eqasim-bavaria @ b20fbe6, file ``bavaria/locations/synthesis/education.py``.
...
def execute(context):
    ...
    # Load locations
    df_locations = context.stage("eqasim_common.locations.education")
