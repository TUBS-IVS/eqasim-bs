...
def configure(context):
    ...
    context.config("braunschweig.buildings_path", "bavaria/buildings")
...
def execute(context):
    ...
    start_index = 0
    for path in glob.glob("{}/{}/*_Hausumringe.zip".format(context.config("data_path"), context.config("braunschweig.buildings_path"))):
