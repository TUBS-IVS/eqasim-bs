...
def configure(context):
    ...
    context.config("braunschweig.work_flow_path", "bavaria/a6502c_202200.xla")

    context.stage("eqasim_common.data.spatial.codes")

def execute(context):
    # Load data
    df = pd.read_excel("{}/{}".format(context.config("data_path"), context.config("braunschweig.work_flow_path")),
    ...
    df_codes = context.stage("eqasim_common.data.spatial.codes")
