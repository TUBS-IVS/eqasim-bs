...
| [commute_day_state_measurement](../registry/features/commute_day_state_measurement.yml) | validation | active | ON | A/s/s | 4 | -- | marker | committed | measured_vs_reference (`commute-day-state-phase-a-2026-09-05`) | pending |
