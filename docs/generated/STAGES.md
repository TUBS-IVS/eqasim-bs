...
| [synthesis.population.spatial.secondary.locations](../registry/stages/synthesis.population.spatial.secondary.locations.yml) | secondary | overridden | x | A/A/A | popsim_mid: `braunschweig.synthesis.locations.secondary_chainsolvers`<br>popsim_open: `braunschweig.synthesis.locations.secondary_chainsolvers`<br>simple_ipf_open: `braunschweig.synthesis.locations.secondary_chainsolvers` | building_potentials_secondary, detour_circuity_curve, escort_passive_joint_location, escort_purpose, leisure_unspecified_subtype, no_answer_codes_excluded, parallel_chainsolvers, secondary_distance_by_purpose, secondary_mid_weekday_universe, secondary_srv_location_types, w_zwd_codeplan_sentinels |
