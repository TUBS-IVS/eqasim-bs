...
| [braunschweig.synthesis.commute_day.home_office_donors_stage](../registry/stages/braunschweig.synthesis.commute_day.home_office_donors_stage.yml) | behavior | braunschweig_new | x | A/-/- | -- | -- |
| [braunschweig.synthesis.commute_day.state_stage](../registry/stages/braunschweig.synthesis.commute_day.state_stage.yml) | behavior | braunschweig_new | x | A/-/- | -- | -- |
...
| [synthesis.output](../registry/stages/synthesis.output.yml) | infrastructure | extended | x | A/A/A | popsim_mid: `braunschweig.synthesis.commute_day.output_day` | -- |
| [synthesis.population.activities](../registry/stages/synthesis.population.activities.yml) | behavior | inherited | x | A/A/A | -- | -- |
| [synthesis.population.activities.final](../registry/stages/synthesis.population.activities.final.yml) | behavior | braunschweig_new | x | A/-/- | popsim_mid: `braunschweig.synthesis.commute_day.activities_day_stage` | -- |
...
| [synthesis.population.spatial.locations](../registry/stages/synthesis.population.spatial.locations.yml) | secondary | inherited | x | A/A/A | popsim_mid: `braunschweig.synthesis.commute_day.spatial_locations_day` | -- |
...
| [synthesis.population.trips.final](../registry/stages/synthesis.population.trips.final.yml) | behavior | braunschweig_new | x | A/-/- | popsim_mid: `braunschweig.synthesis.commute_day.trips_day_stage` | -- |
