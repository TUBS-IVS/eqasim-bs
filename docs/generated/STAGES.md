...
| [braunschweig.analysis.synthesis.departure_time_vs_srv](../registry/stages/braunschweig.analysis.synthesis.departure_time_vs_srv.yml) | analysis | braunschweig_new | x | A/s/s | -- | -- |
...
| [synthesis.population.trips](../registry/stages/synthesis.population.trips.yml) | behavior | overridden | x | A/A/A | popsim_mid: `braunschweig.popsim.trips_stage`<br>popsim_open: `braunschweig.popsim.trips_stage` | escort_passive_from_adult, escort_purpose, home_closure_model, no_answer_codes_excluded, purpose_main_fold_code_10, rbw_leg_convention |
| [synthesis.population.trips.final](../registry/stages/synthesis.population.trips.final.yml) | behavior | braunschweig_new | x | A/-/- | popsim_mid: `braunschweig.synthesis.commute_day.trips_day_stage` | commute_day_state, general_day_absence |
