...
| [braunschweig.analysis.synthesis.plan_structure_vs_srv](../registry/stages/braunschweig.analysis.synthesis.plan_structure_vs_srv.yml) | analysis | braunschweig_new | x | A/s/s | -- | diary_plan_match, home_closure_model, rbw_leg_convention |
...
| [matsim.scenario.population](../registry/stages/matsim.scenario.population.yml) | matsim | overridden | x | A/A/A | popsim_mid: `braunschweig.matsim.scenario.population`<br>popsim_open: `braunschweig.matsim.scenario.population` | carless_routing_remode, rbw_leg_convention, urban_parking |
...
| [synthesis.output](../registry/stages/synthesis.output.yml) | infrastructure | overridden | x | A/A/A | popsim_mid: `braunschweig.synthesis.commute_day.output_day`<br>popsim_open: `synthesis.output`<br>simple_ipf_open: `synthesis.output` | commute_day_state, rbw_leg_convention |
...
| [synthesis.population.trips.final](../registry/stages/synthesis.population.trips.final.yml) | behavior | braunschweig_new | x | A/-/- | popsim_mid: `braunschweig.synthesis.commute_day.trips_day_stage` | commute_day_state |
