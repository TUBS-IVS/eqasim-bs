...
| [braunschweig.synthesis.commute_day.home_office_donors_stage](../registry/stages/braunschweig.synthesis.commute_day.home_office_donors_stage.yml) | behavior | braunschweig_new | x | A/-/- | -- | commute_day_state |
...
| [data.census.filtered](../registry/stages/data.census.filtered.yml) | population | overridden | x | A/A/A | popsim_mid: `braunschweig.popsim.stage`<br>popsim_open: `braunschweig.popsim.stage`<br>simple_ipf_open: `braunschweig.ipf.attributed` | age_aware_composition, diary_plan_match, home_closure_model, housing_tenure, income_spatial_tilt, ipf_synthesis_legacy, kreis_income_control, ownership_grid_1km, participation_universe_controls, placement_income_l2, popsim_method, sex_aware_couples, srv_participation_controls, tier3_kreis_controls |
...
| [synthesis.population.trips](../registry/stages/synthesis.population.trips.yml) | behavior | overridden | x | A/A/A | popsim_mid: `braunschweig.popsim.trips_stage`<br>popsim_open: `braunschweig.popsim.trips_stage` | escort_purpose, home_closure_model, rbw_leg_convention |
