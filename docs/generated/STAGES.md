...
| [braunschweig.analysis.synthesis.departure_time_vs_srv](../registry/stages/braunschweig.analysis.synthesis.departure_time_vs_srv.yml) | analysis | braunschweig_new | x | A/-/- | -- | departure_time_model |
| [braunschweig.analysis.synthesis.plan_structure_vs_srv](../registry/stages/braunschweig.analysis.synthesis.plan_structure_vs_srv.yml) | analysis | braunschweig_new | x | A/s/s | -- | diary_plan_match, general_day_absence, home_closure_model, rbw_leg_convention |
| [braunschweig.analysis.synthesis.work_participation_by_kreis](../registry/stages/braunschweig.analysis.synthesis.work_participation_by_kreis.yml) | validation | braunschweig_new | x | A/s/s | -- | commute_day_state_measurement, general_day_absence |
...
| [braunschweig.data.hts.mid_donor](../registry/stages/braunschweig.data.hts.mid_donor.yml) | population | braunschweig_new | x | A/A/- | -- | incommuter_donor_demographics, popsim_method |
...
| [braunschweig.popsim.completed_donor](../registry/stages/braunschweig.popsim.completed_donor.yml) | population | braunschweig_new | x | A/-/- | -- | diary_plan_match, participation_universe_controls, popsim_method |
| [braunschweig.synthesis.commute_day.home_office_donors_stage](../registry/stages/braunschweig.synthesis.commute_day.home_office_donors_stage.yml) | behavior | braunschweig_new | x | A/-/- | -- | commute_day_state, escort_passive_from_adult, purpose_main_fold_code_10 |
...
| [braunschweig.synthesis.day_absence.absence_stage](../registry/stages/braunschweig.synthesis.day_absence.absence_stage.yml) | behavior | braunschweig_new | x | A/-/- | -- | general_day_absence |
| [braunschweig.synthesis.incommuters](../registry/stages/braunschweig.synthesis.incommuters.yml) | cordon | braunschweig_new | x | A/A/- | -- | cordon_mode_balancer, einpendler_injection, incommuter_donor_demographics, incommuter_time_chronology |
...
| [braunschweig.synthesis.student_incommuters](../registry/stages/braunschweig.synthesis.student_incommuters.yml) | cordon | braunschweig_new | x | A/A/- | -- | incommuter_donor_demographics, incommuter_time_chronology, student_incommuters |
| [braunschweig.synthesis.vehicles.cars.household](../registry/stages/braunschweig.synthesis.vehicles.cars.household.yml) | fleet | braunschweig_new | x | A/A/A | -- | fleet_consistency_v2, fleet_electric_calibration, fleet_hsn_tsn_attributes, fleet_realism_upgrade, fleet_segment_brand_mix, fleet_wohnmobile_age_tilt, household_fleet |
| [data.census.filtered](../registry/stages/data.census.filtered.yml) | population | overridden | x | A/A/A | popsim_mid: `braunschweig.popsim.stage`<br>popsim_open: `braunschweig.popsim.stage`<br>simple_ipf_open: `braunschweig.ipf.attributed` | age_aware_composition, diary_plan_match, escort_passive_from_adult, home_closure_model, housing_tenure, income_spatial_tilt, ipf_synthesis_legacy, kreis_income_control, ownership_grid_1km, participation_universe_controls, placement_income_l2, popsim_method, purpose_main_fold_code_10, sex_aware_couples, srv_participation_controls, tier3_kreis_controls |
...
| [matsim.scenario.population](../registry/stages/matsim.scenario.population.yml) | matsim | overridden | x | A/A/A | popsim_mid: `braunschweig.matsim.scenario.population`<br>popsim_open: `braunschweig.matsim.scenario.population` | carless_routing_remode, general_day_absence, rbw_leg_convention, urban_parking |
...
| [synthesis.output](../registry/stages/synthesis.output.yml) | infrastructure | overridden | x | A/A/A | popsim_mid: `braunschweig.synthesis.commute_day.output_day`<br>popsim_open: `synthesis.output`<br>simple_ipf_open: `synthesis.output` | commute_day_state, general_day_absence, rbw_leg_convention |
| [synthesis.population.activities](../registry/stages/synthesis.population.activities.yml) | behavior | inherited | x | A/A/A | -- | -- |
| [synthesis.population.activities.final](../registry/stages/synthesis.population.activities.final.yml) | behavior | braunschweig_new | x | A/-/- | popsim_mid: `braunschweig.synthesis.commute_day.activities_day_stage` | commute_day_state |
| [synthesis.population.enriched](../registry/stages/synthesis.population.enriched.yml) | attributes | overridden | x | A/A/A | popsim_mid: `braunschweig.popsim.enriched_adapter`<br>popsim_open: `braunschweig.popsim.enriched_adapter`<br>simple_ipf_open: `braunschweig.synthesis.population.enriched` | consistent_car_availability, driving_licence_enrichment, economic_status_bayes, household_income_distribution, housing_tenure, income_aware_cars, pt_subscription_conditioned, rbw_leg_convention, reactivated_person_attributes |
...
| [synthesis.population.spatial.locations](../registry/stages/synthesis.population.spatial.locations.yml) | secondary | overridden | x | A/A/A | popsim_mid: `braunschweig.synthesis.commute_day.spatial_locations_day`<br>popsim_open: `synthesis.population.spatial.locations`<br>simple_ipf_open: `synthesis.population.spatial.locations` | commute_day_state |
...
| [synthesis.population.spatial.secondary.distance_distributions](../registry/stages/synthesis.population.spatial.secondary.distance_distributions.yml) | secondary | overridden | x | A/A/A | popsim_mid: `braunschweig.popsim.distance_distributions` | escort_passive_from_adult, leisure_unspecified_subtype, no_answer_codes_excluded, purpose_main_fold_code_10, secondary_distance_by_purpose, secondary_mid_weekday_universe, w_zwd_codeplan_sentinels |
| [synthesis.population.spatial.secondary.locations](../registry/stages/synthesis.population.spatial.secondary.locations.yml) | secondary | overridden | x | A/A/A | popsim_mid: `braunschweig.synthesis.locations.secondary_chainsolvers`<br>popsim_open: `braunschweig.synthesis.locations.secondary_chainsolvers`<br>simple_ipf_open: `braunschweig.synthesis.locations.secondary_chainsolvers` | building_potentials_secondary, detour_circuity_curve, escort_purpose, leisure_unspecified_subtype, no_answer_codes_excluded, parallel_chainsolvers, secondary_distance_by_purpose, secondary_mid_weekday_universe, secondary_srv_location_types, w_zwd_codeplan_sentinels |
| [synthesis.population.trips](../registry/stages/synthesis.population.trips.yml) | behavior | overridden | x | A/A/A | popsim_mid: `braunschweig.popsim.trips_stage`<br>popsim_open: `braunschweig.popsim.trips_stage` | departure_time_model, escort_passive_from_adult, escort_purpose, home_closure_model, no_answer_codes_excluded, purpose_main_fold_code_10, rbw_leg_convention |
| [synthesis.population.trips.final](../registry/stages/synthesis.population.trips.final.yml) | behavior | braunschweig_new | x | A/-/- | popsim_mid: `braunschweig.synthesis.commute_day.trips_day_stage` | commute_day_state, departure_time_model, general_day_absence |
