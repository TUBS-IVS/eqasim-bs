...
| [synthesis.output](../registry/stages/synthesis.output.yml) | infrastructure | overridden | x | A/A/A | popsim_mid: `braunschweig.synthesis.commute_day.output_day`<br>popsim_open: `synthesis.output`<br>simple_ipf_open: `synthesis.output` | commute_day_state |
