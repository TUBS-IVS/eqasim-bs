...
| [braunschweig.data.vrb.zone_polygons](../registry/stages/braunschweig.data.vrb.zone_polygons.yml) | matsim | braunschweig_new | -- | -/-/- | -- | vrb_zone_fare_model |
...
| [braunschweig.synthesis.vehicles.cars.household](../registry/stages/braunschweig.synthesis.vehicles.cars.household.yml) | fleet | braunschweig_new | x | A/A/A | -- | fleet_consistency_v2, fleet_electric_calibration, fleet_gemeinde_bev_composition_tilt, fleet_hsn_tsn_attributes, fleet_realism_upgrade, fleet_segment_brand_mix, fleet_wohnmobile_age_tilt, household_fleet, performance_equivalence |
| [data.census.filtered](../registry/stages/data.census.filtered.yml) | population | overridden | x | A/A/A | popsim_mid: `braunschweig.popsim.stage`<br>popsim_open: `braunschweig.popsim.stage`<br>simple_ipf_open: `braunschweig.ipf.attributed` | age_aware_composition, diary_plan_match, escort_passive_from_adult, home_closure_model, housing_tenure, income_spatial_tilt, ipf_synthesis_legacy, kreis_income_control, mid_passenger_availability, ownership_grid_1km, participation_universe_controls, placement_income_l2, popsim_method, purpose_main_fold_code_10, sex_aware_couples, srv_participation_controls, tier3_kreis_controls |
...
| [synthesis.output](../registry/stages/synthesis.output.yml) | infrastructure | overridden | x | A/A/A | popsim_mid: `braunschweig.synthesis.commute_day.output_day`<br>popsim_open: `synthesis.output`<br>simple_ipf_open: `synthesis.output` | commute_day_state, general_day_absence, mid_passenger_availability, rbw_leg_convention |
...
| [synthesis.population.spatial.home.locations](../registry/stages/synthesis.population.spatial.home.locations.yml) | home | overridden | x | A/A/A | popsim_mid: `braunschweig.synthesis.locations.home_cell`<br>popsim_open: `braunschweig.synthesis.locations.home_cell` | alkis_home_matching, cell_accurate_homes, performance_equivalence |
...
| [synthesis.population.spatial.secondary.locations](../registry/stages/synthesis.population.spatial.secondary.locations.yml) | secondary | overridden | x | A/A/A | popsim_mid: `braunschweig.synthesis.locations.secondary_chainsolvers`<br>popsim_open: `braunschweig.synthesis.locations.secondary_chainsolvers`<br>simple_ipf_open: `braunschweig.synthesis.locations.secondary_chainsolvers` | building_potentials_secondary, detour_circuity_curve, escort_passive_joint_location, escort_passive_joint_surrogate, escort_purpose, leisure_unspecified_subtype, no_answer_codes_excluded, parallel_chainsolvers, secondary_distance_by_purpose, secondary_mid_weekday_universe, secondary_srv_location_types, w_zwd_codeplan_sentinels |
| [synthesis.population.trips](../registry/stages/synthesis.population.trips.yml) | behavior | overridden | x | A/A/A | popsim_mid: `braunschweig.popsim.trips_stage`<br>popsim_open: `braunschweig.popsim.trips_stage` | departure_time_model, escort_passive_from_adult, escort_purpose, home_closure_model, no_answer_codes_excluded, performance_equivalence, purpose_main_fold_code_10, rbw_leg_convention |
