...
- **MATSim**: `braunschweig.data.vrb.zone_polygons`, `braunschweig.data.vrb.zones`
...
- **Validation**: `braunschweig.analysis.cordon_validation`, `braunschweig.analysis.reference.srv.commute_distance`, `braunschweig.analysis.synthesis.commute_distance_by_kreis`, `braunschweig.analysis.synthesis.work_participation_by_kreis`, `braunschweig.analysis.verbindungen_validation`, `braunschweig.data.mid.references`, `braunschweig.data.verbindungen.margins`
