...
- Features: 98 | stages: 125 | datasets: 75 | ADRs: 126 | run manifests: 46
...
| [Resource-adaptive configuration (machine-derived budget, ceiling clamps, chainsolver shard/worker split)](../registry/features/resource_adaptive_config.yml) | active | ON | A/A/A | unvalidated |  |
