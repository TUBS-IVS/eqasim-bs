...
- Features: 79 | stages: 122 | datasets: 63 | ADRs: 105 | run manifests: 33
...
| Feature | Lifecycle | Prod | Pipelines | Validation | Issue |
|---|---|---|---|---|---|
| [Commute-day-state model (far/weekly out-commuters)](../registry/features/commute_day_state.yml) | active | ON | A/-/- | measured_vs_reference (`commute-day-state-phase-b-proof-100pct-2026-09-05`) | [#244](https://github.com/TUBS-IVS/eqasim-bs/issues/244) |
