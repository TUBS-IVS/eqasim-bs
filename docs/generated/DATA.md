...
| [srv2023_primary_distance_targets](../registry/data/srv2023_primary_distance_targets.yml) | calibration_target, validation_reference | committed (`scripts/extract_srv_primary_distance_targets.py`) | `data/braunschweig/srv/srv2023_commute_distance_by_kreis.csv` | -/-/o | no |
