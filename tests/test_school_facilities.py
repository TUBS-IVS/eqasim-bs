...
def _csv_frame():
    return pd.DataFrame({
        "school_id": ["abs_1", "abs_2", "bbs_3", "bbs_4"],
        "name": ["A", "B", "C", "D"],
        "level": ["grundschule", "sekundar_1", "oberstufe", "bbs"],
        "capacity": [200.0, 150.0, 800.0, 800.0],
        "ags8": ["03101000", "03158001", "03101000", "03101000"],
        "kreis5": ["03101", "03158", "03101", "03101"],
        "x": [605000.0, 612000.0, 605500.0, 606000.0],
        "y": [5790000.0, 5780000.0, 5790500.0, 5790200.0],
        "geocode_quality": ["address", "address", "plz_centroid", "address"],
        "dist_to_osm_edu_m": [40.0, 120.0, 300.0, 50.0],
