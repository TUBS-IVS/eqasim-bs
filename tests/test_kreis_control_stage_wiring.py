...
def test_active_kreis_entries_all_default_on_for_mid():
    ...
    # Empty config -> all seven entries default "on" (project rule: new features default
    ...
    # work_participation (third person-level entry) is feature #224 task 4.
...
def test_active_kreis_entries_individual_toggle():
    ...
    # Turning off only number_of_cars keeps the other six entries active (all seven
