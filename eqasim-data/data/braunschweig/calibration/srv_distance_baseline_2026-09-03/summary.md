...
Parameters: detour_factor=1.3, emd_threshold=0.08, min_persons=200, max_unmatched_home_share=0.05, warn_unmatched_destination_share=0.3, sampling_rate=1.0
Generated at: 2026-09-03T21:49:52.291000+00:00
...
- **intra**: build = False -- do not build: no gap in any Kreis with >= 200 reference persons nor in the aggregate (EMD threshold 0.08, noise floor respected)
...
## Education (per level)
- **kindergarten**: build = False -- do not build: no gap in any Kreis with >= 200 reference persons nor in the aggregate (EMD threshold 0.08, noise floor respected)
...
- **sekundar_1**: build = False -- do not build: no gap in any Kreis with >= 200 reference persons nor in the aggregate (EMD threshold 0.08, noise floor respected)
- **upper_secondary**: build = False -- do not build: no gap in any Kreis with >= 200 reference persons nor in the aggregate (EMD threshold 0.08, noise floor respected)
- **university**: build = True -- build: gap (EMD > 0.08 and > noise floor) in decisive cell(s) ['zgb'] (Kreis with >= 200 reference persons, or the aggregate)
