...
|---|---|---|---|---|---|---|
| 03101 | 123903 | 0.670 | 0.628 | 4.20 | 0.178 | 2268 |
| 03102 | 45605 | 0.739 | 0.714 | 2.50 | 0.059 | 663 |
| 03103 | 53805 | 0.689 | n/a | n/a | n/a | 0 |
| 03151 | 87384 | 0.649 | 0.644 | 0.53 | 0.179 | 1521 |
| 03153 | 58766 | 0.693 | 0.692 | 0.05 | 0.078 | 935 |
| 03154 | 42037 | 0.657 | 0.667 | -0.99 | 0.121 | 754 |
| 03157 | 65712 | 0.636 | 0.612 | 2.46 | 0.147 | 1067 |
| 03158 | 58545 | 0.688 | 0.660 | 2.79 | 0.150 | 808 |
| zgb | 535757 | 0.674 | 0.651 | 2.25 | 0.142 | 8016 |
...
ZGB employed persons: 535757 (sample count); of them 372052 with an assigned workplace and therefore a drawn state.
...
The general day-absence draw (issue #370) marks 0 employed person(s) 'absent' before the shares above were computed -- including any of them without an assigned workplace, who would otherwise have been counted as no_workplace, and any of them already 'absent' as a commute-day far commuter, for whom the override has no effect (column n_absent_general).

| quantity (share of employed persons) | model | SrV 2023 | delta (pp) | +/- 3 pp |
|---|---|---|---|---|
| at_workplace vs SrV work trip | 0.673 | 0.651 | 2.22 | within |
| home vs SrV full home-office day | 0.013 | 0.142 | -12.86 | outside |
| absent vs SrV neither | 0.008 | 0.207 | -19.92 | outside |
| employed without a work trip vs SrV remainder | 0.326 | 0.349 | -2.25 | within |
| no_workplace (employed, no assigned workplace) | 0.306 | n/a | n/a | not compared |
