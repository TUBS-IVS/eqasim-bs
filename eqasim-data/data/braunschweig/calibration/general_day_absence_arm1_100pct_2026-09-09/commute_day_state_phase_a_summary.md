...
Parameters: detour_factor=1.3, max_unmatched_home_share=0.05, max_unresolved_destination_share=0.05, edge_tolerance_km=5.0, sampling_rate=1.0, output_subdir=analysis/commute_day_state_phase_a, commute_day_state_enabled=True, check_1_tolerance_pp=3.0, max_states_outside_employed_share=0.05, day_absence_enabled=True
Generated at: 2026-09-09T14:12:27.382371+00:00
...
|---|---|---|---|---|---|---|
| 03101 | 123903 | 0.630 | 0.628 | 0.26 | 0.178 | 2268 |
| 03102 | 45605 | 0.699 | 0.714 | -1.44 | 0.059 | 663 |
| 03103 | 53805 | 0.652 | n/a | n/a | n/a | 0 |
| 03151 | 87384 | 0.618 | 0.644 | -2.65 | 0.179 | 1521 |
| 03153 | 58766 | 0.655 | 0.692 | -3.74 | 0.078 | 935 |
| 03154 | 42037 | 0.623 | 0.667 | -4.43 | 0.121 | 754 |
| 03157 | 65712 | 0.604 | 0.612 | -0.80 | 0.147 | 1067 |
| 03158 | 58545 | 0.653 | 0.660 | -0.74 | 0.150 | 808 |
| zgb | 535757 | 0.638 | 0.651 | -1.35 | 0.142 | 8016 |
...
- (home, destination) Kreis pairs measured: 645
- EXT workers measured: 50128
...
ZGB employed persons: 535757 (sample count); of them 381022 with an assigned workplace and therefore a drawn state.
A further 18672 worker(s) with a ZGB home Kreis have an assigned workplace but are NOT flagged employed
...
The general day-absence draw (issue #370) marks 28826 employed person(s) 'absent' before the shares above were computed -- including any of them without an assigned workplace, who would otherwise have been counted as no_workplace, and any of them already 'absent' as a commute-day far commuter, for whom the override has no effect (column n_absent_general).

| quantity (share of employed persons) | model | SrV 2023 | delta (pp) | +/- 3 pp |
|---|---|---|---|---|
| at_workplace vs SrV work trip | 0.637 | 0.651 | -1.38 | within |
| home vs SrV full home-office day | 0.013 | 0.142 | -12.92 | outside |
| absent vs SrV neither | 0.061 | 0.207 | -14.58 | outside |
| employed without a work trip vs SrV remainder | 0.362 | 0.349 | 1.35 | within |
| no_workplace (employed, no assigned workplace) | 0.289 | n/a | n/a | not compared |
